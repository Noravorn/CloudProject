...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['submit'])) {
    ...
    $UserID = htmlspecialchars(filter_input(INPUT_POST, 'user-name', FILTER_SANITIZE_NUMBER_INT));
    ...
    try {
        ...
        if (isset($PetBloodId) && isset($Clinic)) {
            ...
            if ($stmt->rowCount() > 0) {
                ...
                $error = "Failed to insert the donation record. Please try again.";
            }
        }
                    ...
                    <form action="donate.php" method="post">
                        ...
                        <select id="user-name" name="user-name" required>
                            ...
                            try {
                                ...
                                echo "<option value=''>Error loading users. Please try again later.</option>";
                            }
                            ?>
                        </select>
